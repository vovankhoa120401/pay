...
namespace Pay1193.Services
{
    public interface IPayService
    {
        ...
        decimal OvertimeHours(object hoursWorked, decimal contractualHours);
        decimal ContratualEarnings(decimal contractualHours, object hoursWorked, decimal hourlyRate);
